...
st.caption('This proof-of-concept demonstrate how to use **:green[folium]** and **:green[streamlit]** to show dynamic geographic information (geojson) on an interactive dashboard. This page was created entirely in Python.')
